...
TessellationCube::TessellationCube(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int lresolution)
{
...
void TessellationCube::initBuffers(ID3D11Device* device)
{
	VertexType* vertices;
...
void TessellationCube::sendData(ID3D11DeviceContext* deviceContext)
{
	unsigned int stride;
	unsigned int offset;
